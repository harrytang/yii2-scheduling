...
First of all, you should include dependency to the `powerkernel\yii2-scheduling` into your composer.json:

```
...
'require': {
    "powerkernel/yii2-schedule": "*"
}
...
```
...
```php
'schedule' => 'powerkernel\scheduling\Schedule',
```
